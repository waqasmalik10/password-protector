...
class Message extends Component {
    ...
    render(){
        ...
        return (
            message && !this.state.read ?  (
                <Transition.Root show={true} as={Fragment}>
                <Dialog as="div" static className="fixed z-10 inset-0 overflow-y-auto" open={true} onClose={this.closeModel}>
  ...
  export default connect(mapStatToProps, mapDispatchToProps)(withRouter(Message));